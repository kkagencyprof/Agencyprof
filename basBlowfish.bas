...
Public Function blf_Key(aKey() As Byte, nKeyLen As Integer) As Boolean
    ...
    If blf_Initialise(aKey, nKeyLen) = 1 Then blf_Key = True
...
' Added Version 5: Replacement for blf_Key to avoid specifying keylen
    ...
    If blf_Initialise(aKey, nKeyLen) = 1 Then blf_KeyInit = True
End Function
...
Public Function blf_Enc(awData() As Long, nWords As Long)
...
Public Function blf_Dec(awData() As Long, nWords As Long)
' Version 5: Changed Integer counters to Long
    Dim i As Long
